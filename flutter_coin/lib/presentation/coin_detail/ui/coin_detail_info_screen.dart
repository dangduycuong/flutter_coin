                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          _heightSpacing(8.h),
                          _setDataText(
                              _convertIntToDateTime(_bloc.coin.listedAt ?? 0),
                              false),
                        ],
                      ),
                      _widthSpacing(10.w),
          ...
          if (index == 0) {
            return Column(
              children: [
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            ...
                            _heightSpacing(8.h),
                            _textMarketCap(
                                int.parse(_bloc.coin.marketCap ?? '')),
                          ],
                        ),
                        _widthSpacing(10.w),
                        Column(
                          ...
                          children: [
                            ...
                            _setTitleText('Total'),
                            _heightSpacing(8.h),
                            _setDataText(_bloc.coin.supply?.total ?? '', true),
                            _heightSpacing(8.h),
                            _setTitleText('Listed At'),
                            _heightSpacing(8.h),
                            _setDataText(
                        ...
                        Column(
                          ...
                          children: [
                            _setTitleText('24h Volume'),
                            _heightSpacing(8.h),
                            _setDataText(_bloc.coin.volume ?? '', true),
                            _heightSpacing(8.h),
                            _setTitleText('Number Of Markets'),
                            _heightSpacing(8.h),
                            _setDataText('${_bloc.coin.numberOfMarkets}', true),
                            ...
                            _heightSpacing(8.h),
                            _setDataText(
                                '${_bloc.coin.numberOfExchanges}', true),
                          ],
                        ),
                      ],
                    ),
                ...
                _heightSpacing(32),
                _setHeaderTitle('${_bloc.coin.symbol} 1H Chart'),
                _heightSpacing(16),
              ],
            );
          }
